...
var assigend_property_table = $(".assigend-property-table"),
  ...
  recent_visits_table = $(".recent-visits-table"),
  dt_basic;
          ...
          render: function (data, type, full, meta) {
            return (
              '<div class="d-inline-block">' +
                '<a href="javascript:;" class="btn btn-sm btn-icon"><i class="text-primary ti ti-file-description"></i></a>'+
              '</div>'
            );
          }
        }
...
if (recent_visits_table.length) {
    dt_basic = recent_visits_table.DataTable({
      ajax: assetsPath + 'json/table-datatable2.json',
      columns: [
        { data: '' },
        { data: 'id' },
      ...
      order: [[2, 'asc']],
      dom: '<"card-header flex-column flex-md-row"<"head-label text-center"><"dt-action-buttons text-end pt-3 pt-md-0">><"row"<"col-sm-12 col-md-6"><"col-sm-12 col-md-6 d-flex justify-content-center justify-content-md-end"f>>t<"row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 7,
      lengthMenu: [7, 10, 25, 50, 75, 100],
    ...
    $('div.head-label').html('<h4 class="card-title mb-0">Recent Visits</h4>');
  }
